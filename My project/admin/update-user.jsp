...
<head>
    ...
    <title>Update User | Optic Lens</title>
</head>
<body>
    <!-- header section -->
    <header class="header">
    ...
    <section class="heading">
        <h1>Update User</h1>
        <p><a href="http://localhost:8081/OpticLens/admin/index.jsp">Home&nbsp;<i class="fas fa-home" style="color:black;text-decoration: none;"></i></a> >> <a href="http://localhost:8081/OpticLens/admin/update-user.jsp">Update user</a></p>
    </section>

    <!--Update user section starts-->
    <section class="login-form">

        <form action="http://localhost:8081/OpticLens/admin/update.jsp" method="post">
            <h3>Update User</h3>
            <div class="inputbox">
